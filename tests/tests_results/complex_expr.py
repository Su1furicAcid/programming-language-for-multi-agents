...
def console(input: Any) -> None:
    ...
    """
    print(input)
students = [{"name": "Alice", "age": 20, "grades": [90, 85, 88]}, {"name": "Bob", "age": 21, "grades": [78, 82, 80]}, {"name": "Charlie", "age": 19, "grades": [95, 92, 96]}]
my_class = {"students": students, "class_name": "Physics"}
total_score = 0
total_count = 0
